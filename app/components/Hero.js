...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center bg-transparent p-10"> {/* Set background to transparent */}
      ...
      <p className="text-2xl text-white mb-6">“Awaken Your Potential”</p>
      <a
        href="#"
        className="flex justify-center items-center gap-2 px-4 py-2 w-[250px] h-[60px] rounded-[25px] bg-gradient-to-r from-[#B20101] to-[#C42700] transition duration-300 hover:opacity-90 mb-8 z-10"
      >
        Get Started
      </a>
